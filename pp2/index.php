 ...
 * Demonstrates: Variables, Loops, Conditionals, Functions, Events, Sliders
 */
...
// If connection failed, show friendly instruction and stop to avoid fatal errors
if (!$conn) {
    ...
    echo "<p>Please initialize the database by visiting <a href='config/init_db.php'>config/init_db.php</a> in your browser or run it via CLI: <code>php config/init_db.php</code>.</p>";
    ...
    <section class="featured-products">
        ...
        <div class="products-grid">
            ...
            foreach ($featuredProducts as $product): 
                // Conditional: Show only first 8 products
                if ($count >= 8) break;
                $count++;
            ?>
