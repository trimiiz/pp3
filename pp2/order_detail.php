<?php
/**
 * Order Detail Page - View order items and status
 */
...
// Get order - users can only see their own orders (or guest orders - we'd need session/email match)
...
// If logged in, verify it's their order. Guests can't view order details (no auth)
