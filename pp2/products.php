...
/**
 * Products Page
 * Demonstrates: Loops (for, foreach), Conditionals, Functions, Variables, Parameters
 */
...
// Conditional: Get products based on category or search
if ($search) {
...
<div class="container">
    <div class="page-header">
        <h1>
            <?php 
            // Conditional display based on parameters
            if ($category) {
